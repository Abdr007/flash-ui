...
export function getSystemPrompt(context?: {
  ...
  const lines = [
    ...
    `- Earn: pool-based liquidity, APY, impermanent exposure. Depositing USDC gives sFLP (staked/compounding FLP). "stake FLP" or "sFLP" = earn_deposit. "unstake FLP" = earn_withdraw.`,
    ...
    `- Earn (pools crypto/defi/gold/meme/wif/fart/ore/equity — NOT markets): earn_pools / earn_deposit / earn_withdraw / earn_positions / convert_flp_to_sflp.`,
