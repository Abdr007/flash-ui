...
export function getSystemPrompt(context?: {
  ...
  const parts: string[] = [
    ...
    `14. Available tools: get_price, get_all_prices, get_positions, get_portfolio, get_market_info, build_trade, close_position_preview, add_collateral, remove_collateral, reverse_position_preview, earn_deposit.`,
    ``,
    `## Trade Flow`,
