    ...
    <div className="landing-scroll bg-bg-root text-text-primary min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 overflow-hidden">
        ...
        >
          {/* Badge */}
          <div
            className="flex items-center gap-2.5 px-5 py-2 rounded-full mb-12"
            style={{
          ...
          >
            <span
              ...
              style={{ background: "var(--color-brand-teal)", boxShadow: "0 0 8px rgba(51,201,161,0.5)" }}
            />
            <span className="text-[13px] font-medium tracking-wide" style={{ color: "var(--color-brand-teal)" }}>
              Built on Flash Trade · Solana
            </span>
          </div>

          {/* Headline */}
          <h1
            className="text-[52px] sm:text-[68px] md:text-[84px] lg:text-[96px] font-bold tracking-[-0.03em] leading-[1] mb-8"
          ...
          {/* Subtitle */}
          <p
            className="text-[18px] sm:text-[20px] text-text-secondary leading-relaxed mb-16 max-w-2xl px-4"
            ...
            >
              ...
              >
                ...
                <div className="ml-auto flex items-center gap-2">
                  <span
                    className="w-2 h-2 rounded-full"
                    style={{ background: "var(--color-brand-teal)", boxShadow: "0 0 8px rgba(51,201,161,0.6)" }}
                  />
              ...
              <div className="px-8 py-8 space-y-5">
                ...
                <div className="flex justify-end">
                  <div
                    className="px-5 py-3 rounded-2xl rounded-br-md"
                ...
                <div className="flex items-start gap-4">
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
                      <path d="M3 13L8 3L13 13H3Z" fill="var(--color-brand-teal)" />
                    </svg>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        style={{ background: "var(--color-accent-long)", boxShadow: "0 0 8px rgba(0,210,106,0.4)" }}
                      />
                      ...
                      <span
                        ...
                        style={{ color: "var(--color-accent-long)", background: "rgba(0,210,106,0.1)" }}
                      >
                        LONG
                      </span>
                      <span className="text-[11px] font-medium ml-auto" style={{ color: "var(--color-brand-teal)" }}>
                        ✓ Ready
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2">
                      ...
                      <div className="px-5 py-3.5" style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                        ...
                        <div className="num font-bold text-[18px]" style={{ color: "var(--color-accent-warn)" }}>
                          $118.66
                        </div>
                      </div>
                    ...
                    <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)" }}>
                      <div
                        className="py-3.5 text-center text-[13px] font-bold tracking-wide"
              ...
              <div className="px-8 pb-6 pt-1">
                <div
                  className="flex items-center rounded-xl px-5 py-3.5"
                  style={{ background: "rgba(14,19,28,0.5)", border: "1px solid rgba(51,201,161,0.08)" }}
                >
                  <span className="text-[14px] text-text-tertiary font-mono flex-1 tracking-wide">
                    Type a command...
                  </span>
                  <div
          ...
          {/* CTAs */}
          <div
            className="flex flex-col sm:flex-row items-center gap-4 sm:gap-5 mt-16"
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2" style={{ opacity: heroOpacity * 0.5 }}>
          <div
            className="w-7 h-11 rounded-full flex items-start justify-center pt-2.5"
            style={{ border: "2px solid rgba(51,201,161,0.12)" }}
          >
            <div
              className="w-1 h-2.5 rounded-full"
              style={{ background: "var(--color-brand-teal)", animation: "typingBounce 2s ease-in-out infinite" }}
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-28 sm:py-36 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-tight mb-6">
            Execution in milliseconds
          </h2>
          <p className="text-[17px] text-text-secondary mb-16 max-w-2xl mx-auto">
            Common commands execute in under 5ms. Deterministic parsing, cached prices, instant preview.
          </p>
          ...
          <div className="glass-card px-10 py-8 max-w-2xl mx-auto">
            <div className="flex items-start justify-between relative">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, var(--color-brand-teal), var(--color-brand-cyan), var(--color-accent-long), var(--color-accent-lime))",
                  opacity: 0.25,
                }}
              />
              {[
                ...
                <div key={i} className="flex flex-col items-center relative z-10 flex-1">
                  ...
                  />
                  <div className="text-[16px] num font-bold mb-1" style={{ color: step.color }}>
                    {step.t}
                  </div>
      ...
      <section className="py-28 sm:py-36 px-6 relative">
        <div
          className="absolute inset-0"
          style={{
            background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(51,201,161,0.03) 0%, transparent 70%)",
          }}
        />
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-[17px] text-text-secondary mb-16 max-w-2xl mx-auto">
            6-layer validation. Simulation before signing. Your wallet never signs a doomed transaction.
          </p>
            ...
            {[
              {
                ...
                desc: "Regex-based compiler. No AI guessing on critical trading paths.",
              },
              {
                icon: "🛡️",
                title: "Pre-Sign Simulation",
                desc: "Every transaction simulated on-chain before your wallet sees it.",
              },
              {
                icon: "🔒",
                title: "6-Layer Firewall",
                desc: "Zod schemas, leverage caps, wallet auth, rate limiting, and more.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="glass-card px-6 py-6 transition-all duration-200 cursor-default"
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translateY(-4px)";
                  e.currentTarget.style.borderColor = "rgba(51,201,161,0.2)";
                  e.currentTarget.style.boxShadow =
                    "0 16px 48px -8px rgba(0,0,0,0.4), 0 0 24px -4px rgba(51,201,161,0.12)";
                }}
                onMouseLeave={(e) => {
      ...
      <section className="py-28 sm:py-36 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div
            className="text-[11px] font-bold tracking-[0.3em] uppercase mb-5"
            style={{ color: "var(--color-accent-long)" }}
          >
            SIMPLICITY
          </div>
          <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold tracking-tight mb-6">
          ...
          <div className="flex flex-col gap-3 max-w-lg mx-auto text-left">
            {[
              ...
              >
                <code
                  className="text-[14px] sm:text-[15px] num font-medium flex-1 whitespace-nowrap"
                  style={{ color: "var(--color-brand-cyan)" }}
                >
                  {ex.cmd}
                </code>
      ...
      <section className="py-36 sm:py-44 px-6 text-center relative">
        <div
          className="absolute inset-0"
          style={{
            background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(51,201,161,0.06) 0%, transparent 70%)",
          }}
        />
      ...
      <footer className="py-10 px-6 text-center relative">
        <div
          ...
          style={{ background: "linear-gradient(90deg, transparent, rgba(51,201,161,0.2), transparent)" }}
        />
