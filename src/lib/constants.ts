...
export const FLASH_API_URL = process.env.NEXT_PUBLIC_FLASH_API_URL || "https://flashapi.trade";
...
export const TOKEN_META: Record<string, { name: string; logo: string; color: string }> = {
  ...
  PENGU: {
    name: "Pudgy Penguins",
    logo: "https://assets.coingecko.com/coins/images/44411/standard/PENGU.jpg",
    color: "#7DD3FC",
  },
  FARTCOIN: {
    name: "Fartcoin",
    logo: "https://assets.coingecko.com/coins/images/43527/standard/fartcoin.jpg",
    color: "#86EFAC",
  },
  ORE: { name: "Ore", logo: "https://assets.coingecko.com/coins/images/36523/standard/ore_logo.png", color: "#F97316" },
  XAU: {
    name: "Gold",
    logo: "https://assets.coingecko.com/coins/images/34558/standard/tether-gold.png",
    color: "#FCD34D",
  },
  NVDA: {
    name: "Nvidia",
    logo: "https://assets.coingecko.com/coins/images/33033/standard/nvidia.png",
    color: "#76B900",
  },
  ...
  BSOL: {
    name: "BlazeStake SOL",
    logo: "https://assets.coingecko.com/coins/images/26636/standard/blazeStake.png",
    color: "#E87E34",
  },
  HSOL: {
    name: "Helius Staked SOL",
    logo: "https://assets.coingecko.com/coins/images/34511/standard/hsol.png",
    color: "#FF6B35",
  },
  VSOL: {
    name: "Validator SOL",
    logo: "https://assets.coingecko.com/coins/images/32440/standard/vsol.png",
    color: "#5B21B6",
  },
  INF: {
    name: "Infinity SOL",
    logo: "https://assets.coingecko.com/coins/images/35288/standard/inf.png",
    color: "#22D3EE",
  },
  // FAF
  ...
  TRUMP: {
    name: "TRUMP",
    logo: "https://assets.coingecko.com/coins/images/44261/standard/trump.jpg",
    color: "#D4AF37",
  },
  RENDER: {
    name: "Render",
    logo: "https://assets.coingecko.com/coins/images/11636/standard/rndr.png",
    color: "#1F1F3D",
  },
  HNT: {
    name: "Helium",
    logo: "https://assets.coingecko.com/coins/images/4284/standard/Helium_HNT.png",
    color: "#474DFF",
  },
  ONDO: {
    name: "Ondo Finance",
  ...
  KMNO: {
    name: "Kamino",
    logo: "https://assets.coingecko.com/coins/images/36059/standard/kamino.png",
    color: "#2563EB",
  },
  ME: { name: "Magic Eden", logo: "https://assets.coingecko.com/coins/images/40225/standard/me.png", color: "#E11D48" },
  S: {
    name: "Sonic SVM",
    logo: "https://assets.coingecko.com/coins/images/44038/standard/sonic.png",
    color: "#0EA5E9",
  },
  AAVE: {
    name: "Aave",
  ...
  ENA: {
    name: "Ethena",
    logo: "https://assets.coingecko.com/coins/images/36530/standard/ethena.png",
    color: "#4F46E5",
  },
...
function _buildMarkets(): Record<string, { pool: string; dotColor: string }> {
  ...
  const pools =
    (PoolConfigStatic as { pools?: Array<{ poolName?: string; custodies?: Array<{ symbol?: string }> }> }).pools || [];
