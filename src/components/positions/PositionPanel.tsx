    ...
    <div className="w-[280px] shrink-0 bg-bg-root border-l border-border-subtle overflow-y-auto">
      <div className="px-4 py-4 flex flex-col gap-2.5">
        <div className="flex items-center justify-between">
          ...
          {positions.length > 0 && <span className="text-[11px] text-text-tertiary num">{positions.length}</span>}
        </div>

        {!walletConnected ? (
          <span className="text-[13px] text-text-tertiary py-8 text-center">Connect wallet</span>
        ) : positions.length === 0 ? (
          <span className="text-[13px] text-text-tertiary py-8 text-center">No positions</span>
        ) : (
